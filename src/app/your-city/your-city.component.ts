...
export class YourCityComponent implements OnInit {
  ...
  fetchSeattle() {
    ...
    this.http.get("https://air-quality-proxy.herokuapp.com/us/seattle")
    .subscribe(data => {
  ...
  fetchNY() {
    ...
    this.http.get("https://air-quality-proxy.herokuapp.com/us/newYork")
    .subscribe(data => {
      this.loadedNY = data;
    });
  }
  ...
  fetchParis() {
    ...
    this.http.get("https://air-quality-proxy.herokuapp.com/eu/paris")
    .subscribe(data => {
  ...
  fetchFerrandina() {
    ...
    this.http.get("https://air-quality-proxy.herokuapp.com/eu/Ferrandina")
    .subscribe(data => {
  ...
  fetchNewDelhi() {
    ...
    this.http.get("https://air-quality-proxy.herokuapp.com/asia/newDelhi")
    .subscribe(
      data => {
  ...
  fetchSingapore() {
    ...
    this.http.get("https://air-quality-proxy.herokuapp.com/asia/singapore")
    .subscribe(data => {
  ...
  fetchTehran() {
    ...
    this.http.get("https://air-quality-proxy.herokuapp.com/middleEast/tehran")
    .subscribe(data => {
  ...
  fetchAnkara() {
    ...
    this.http.get("https://air-quality-proxy.herokuapp.com/middleEast/ankara")
    .subscribe(data => {
